...
import com.mycj.junsda.view.FreshCircleView.OnAnimatorCancelListener;
...
public class LaputaAlertDialog {
	...
	public LaputaAlertDialog(Context context) {
	...
	public LaputaAlertDialog builder(String msg) {
		// 获取Dialog布局
		View view = LayoutInflater.from(context).inflate(R.layout.view_laputa_alert_dialog, null);
...
//		view.setMinimumWidth(display.getWidth());
	...
	public LaputaAlertDialog builder2(String msg) {
		// 获取Dialog布局
...
//		view.setMinimumWidth(display.getWidth());
	...
	public LaputaAlertDialog setTitle(String title) {
		return this;
	}

	public LaputaAlertDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public LaputaAlertDialog setCanceledOnTouchOutside(boolean cancel) {
